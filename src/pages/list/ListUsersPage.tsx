import { useGetUsersQuery } from "@/store/features/user/user.slice";
import ListItem from "./components/ListItem";

const ListUsersPage = () => {
  const { data, isError, isFetching } = useGetUsersQuery(null, {
    ...
    <div className="my-4  w-full">
      <div className="container mx-auto">
        <div className="mx-auto max-w-md">
          {!isFetching && !isError && (
            <div className="w-full flex flex-col gap-2 row-start-2 items-center">
              <h2 className="text-xl ">List of Users</h2>
              <p className="text-sm">
                Total elements loaded: {Array.isArray(data) && data.length | 0}
              </p>
              <ul className="w-full">
                {data &&
                  Array.isArray(data) &&
          ...
          {isFetching && (
            ...
            >
              ...
              <span className="text-black dark:text-white sr-only">
                Loading...
              </span>
            </div>
          )}
